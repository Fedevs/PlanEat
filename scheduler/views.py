...
from .scheduler import (
    create_or_update_week_menu,
    get_current_menu,
    get_ingredients_needed,
)
...
def scheduler(request):
    ...
    context = dict(menu_changes=menu_changes, full_menu=full_menu, form=form)
...
def ingredients_list(request):
    ...
    context = dict(full_menu=full_menu, ingredients=ingredients, form=form)
...
def _handle_fieldset_addition(request):
    """_handle_fieldset_addition
    handles the addition of a new fieldset to the form.
